...
//#region node_modules/.nitro/vite/services/ssr/assets/router-pKNjeR_z.js
...
var styles_default = "/assets/styles-D9xXJcSp.css";
var APP_NAME = "Anyfile";
...
var Route$3 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Paste text or an image, name it, and download as any file type."
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-k_aJPqgD.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-CkzD9TpV.mjs");
