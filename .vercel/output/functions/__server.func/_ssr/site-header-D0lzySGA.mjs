...
import { o as getBaseURL, r as PACKAGE_VERSION, t as GENERIC_OAUTH_ERROR_CODES } from "./server-DKJpR30c.mjs";
import { l as ArrowDownToLine } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/site-header-D0lzySGA.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-[opacity,transform,background-color,color,box-shadow] duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]", {
	variants: {
		variant: {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "grid size-8 place-items-center rounded-sm bg-raised shadow-[var(--shadow-border)]",
...
function AuthSlot() {
	const { user, isPending } = useCurrentUserState();
	if (isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 w-20 animate-pulse rounded-full bg-raised" });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			user.profileImageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				className: "grid size-8 place-items-center rounded-full bg-raised text-xs font-medium text-muted",
				children: label.charAt(0).toUpperCase()
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "hidden max-w-36 truncate text-sm text-muted sm:inline",
				children: label
			}),
...
//#endregion
export { signIn as i, SiteHeader as n, cn as r, Button as t };
